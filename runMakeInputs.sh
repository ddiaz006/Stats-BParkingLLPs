...
root -l -b -q 'MakeInputs.C("IT", "csc", "M1p0_high")'
root -l -b -q 'MakeInputs.C("IT", "dt" , "M1p0_high")'

root -l -b -q 'MakeInputs.C("IT", "csc", "M2p0_high")'
root -l -b -q 'MakeInputs.C("IT", "dt" , "M2p0_high")'
...
root -l -b -q 'MakeInputs.C("IT", "csc", "M1p0_low")'
root -l -b -q 'MakeInputs.C("IT", "dt" , "M1p0_low")'

root -l -b -q 'MakeInputs.C("IT", "csc", "M2p0_low")'
root -l -b -q 'MakeInputs.C("IT", "dt" , "M2p0_low")'

root -l -b -q 'MakeInputs.C("IT", "csc", "M3p0_low")'
root -l -b -q 'MakeInputs.C("IT", "dt" , "M3p0_low")'
